...
public class HTTPHandler implements HttpHandler
{
	...
	private String getContentType(String fileRequested) 
	{
		...
		else if (fileRequested.endsWith(".tif")
				|| fileRequested.endsWith(".tiff")) 
		{
			return "image/tiff";
		} 
		else if (fileRequested.endsWith(".class")
				|| fileRequested.endsWith(".jar")
				|| fileRequested.endsWith(".bin")
				|| fileRequested.endsWith(".exe")
				|| fileRequested.endsWith(".com")
				|| fileRequested.endsWith(".dll")) 
		{
